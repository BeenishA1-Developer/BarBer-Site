    ...
    <section id="home" className="relative min-h-screen flex items-center bg-[#050505] overflow-hidden">
      ...
      <div className="container mx-auto px-8 md:px-16 pt-32 lg:pt-0 relative z-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-3/5 reveal relative z-30 text-white">
          ...
          <div className="w-full lg:w-2/5 flex justify-center lg:justify-end reveal z-10" style={{ transitionDelay: '500ms' }}>
            <div className="tilt-container">
              <div 
                ref={tiltRef} 
                className="tilt-card relative w-[260px] md:w-[380px] aspect-[4/5] shadow-[0_60px_100px_-20px_rgba(0,0,0,0.9)] border border-white/10 bg-[#0a0a0a]"
              >
                {/* Image Frame */}
                <div className="absolute inset-0 overflow-hidden bg-[#0a0a0a]">
                  <img 
                    src="/assets/hero-signature.png" 
                    alt="Signature Style" 
      ...
      {/* Scroll Down Hint */}
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-6 opacity-30 text-white">
        <div className="w-[1px] h-16 bg-gradient-to-b from-white to-transparent"></div>
        <span className="text-[9px] tracking-[0.8em] uppercase font-bold">Scroll</span>
      </div>
    </section>
  );
};
